...
const HomepageCard = ({
  ...
  return (
    <div className={styles.homepageCard}>
      ...
      <p>
        Explore our wide range of electronics, featuring the latest gadgets and
        devices designed to simplify your life. From high-performance laptops
        and smartphones to smart home devices and accessories, we have
